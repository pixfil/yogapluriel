...
export const metadata: Metadata = {
  title: "Couverture Ardoise - Formdetoit | Artisan Couvreur Bas-Rhin Strasbourg",
  description: "Spécialiste couverture ardoise dans le Bas-Rhin. Installation, réparation, rénovation. Ardoise naturelle française de qualité. Devis gratuit sous 24h.",
  openGraph: {
    title: "Couverture Ardoise | FormDeToit Strasbourg",
    description: "Spécialiste couverture ardoise dans le Bas-Rhin. Installation, réparation, rénovation. Ardoise naturelle française de qualité. Devis gratuit sous 24h.",
    images: [{
      url: '/prestations/ardoise-hero.jpg',
      width: 1200,
      height: 630,
      alt: 'Couverture en ardoise - FormDeToit',
    }],
    type: 'website',
    locale: 'fr_FR',
    siteName: 'FormDeToit',
  ...
  twitter: {
    ...
    title: "Couverture Ardoise | FormDeToit Strasbourg",
    description: "Spécialiste couverture ardoise dans le Bas-Rhin. Installation, réparation, rénovation.",
    images: ['/prestations/ardoise-hero.jpg'],
  },
};

export default function ArdoisePage() {
  const avantages = [
    "Matériau naturel léger et étanche",
    "Non poreux, conserve sa couleur dans le temps", 
    "Résistance au vent et aux intempéries",
    "Croissance limitée de mousses et lichens",
    "Compatible fenêtres de toit et lucarnes",
    "Idéal monuments historiques et maisons de maître"
  ];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="L'excellence en matière de couverture"
        backgroundImage="/background/bg-ardoise.webp"
      />
      ...
      <div className="bg-slate-100 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-yellow">Ardoise</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              <div className="space-y-6">
                <div className="flex items-center justify-center w-16 h-16 bg-yellow rounded-full mb-6">
                  <Image 
                    src="/picto-services/imgi_15_picto-ardoise-jaune.png"
                    alt=""
                    width={32}
                    height={32}
                ...
                <p className="text-xl text-gray-700 leading-relaxed">
                  L'ardoise naturelle représente l'excellence en matière de couverture. 
                  Principalement utilisée dans l'Anjou, la Bretagne et la Loire, elle 
                  provient aujourd'hui d'un artisan ardoisier espagnol suite à la fermeture 
                  des carrières françaises. Matériau noble et durable, non poreux, elle 
                  conserve sa couleur et résiste au vent.
                </p>
            ...
            <AnimatedSection direction="right">
              <div className="relative">
                <Image
                  src="/prestations/a la une/ardoise.webp"
                  alt="Couverture ardoise - Formdetoit Bas-Rhin"
                  width={600}
                  height={500}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Pourquoi choisir l'<span className="text-yellow">Ardoise</span> ?
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Découvrez tous les avantages de ce matériau d'exception pour votre toiture.
              </p>
            </div>
            ...
            <AnimatedSection direction="left">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Votre projet en <span className="text-yellow">Ardoises</span>
                </h2>
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Confiez votre projet de couverture ardoise à nos experts. 
                  Nous vous accompagnons de A à Z pour un résultat à la hauteur 
                  de vos attentes.
                </p>
