...
export const metadata: Metadata = {
  title: "Couverture Cuivre - Formdetoit | Toiture Éternelle Bas-Rhin",
  description: "Spécialiste couverture cuivre dans le Bas-Rhin. Toiture éternelle, patine naturelle verte, matériau noble. Devis gratuit sous 24h.",
};

export default function CuivrePage() {
  const avantages = [
    "Toiture éternelle, durée de vie illimitée",
    "Matériau 100% naturel et recyclable",
    "Évolution esthétique unique (patine verte)",
    "Naturellement antifongique et antibactérien",
    "Aucune maintenance",
    "Valorise exceptionnellement votre patrimoine"
  ];
  ...
  return (
    <>
      ...
      <PageHero 
        title="Couverture Cuivre"
        subtitle="La toiture éternelle par excellence"
      />
      ...
      <div className="bg-slate-100 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-yellow">Cuivre</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              <div className="space-y-6">
                <div className="flex items-center justify-center w-16 h-16 bg-yellow rounded-full mb-6">
                  <Image 
                    src="/picto-services/imgi_19_picto-cuivre-jaune.png"
                    alt=""
                    width={32}
                    height={32}
                ...
                <p className="text-xl text-gray-700 leading-relaxed">
                  Le cuivre représente la "toiture éternelle" par excellence. Ce matériau 
                  noble, 100% naturel et recyclable, développe une patine verte unique 
                  au fil du temps. Initialement orange vif, il traverse les nuances 
                  brun-orange avant d'atteindre sa teinte verte caractéristique, 
                  créant une esthétique incomparable.
                </p>
            ...
            <AnimatedSection direction="right">
              <div className="relative">
                <Image
                  src="/prestations/a la une/cuivre.webp"
                  alt="Couverture cuivre - Formdetoit Bas-Rhin"
                  width={600}
                  height={500}
                ...
                <div className="absolute -bottom-6 -right-6 glass rounded-xl p-6 max-w-xs">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-700">Durée de vie</div>
                  </div>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Pourquoi choisir le <span className="text-yellow">Cuivre</span> ?
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Découvrez tous les avantages de ce matériau d'exception.
              </p>
            </div>
            ...
            <AnimatedSection direction="left">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Votre projet en <span className="text-yellow">Cuivre</span>
                </h2>
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Investissez dans l'excellence avec une toiture cuivre. Matériau 
                  noble aux possibilités de design illimitées, il transforme votre 
                  habitation en œuvre d'art architecturale unique.
                </p>
