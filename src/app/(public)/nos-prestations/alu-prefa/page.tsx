...
export const metadata: Metadata = {
  title: "Aluminium Prefa - Formdetoit | Couverture Haute Performance Bas-Rhin",
  description: "Artisan certifié Prefa dans le Bas-Rhin. Aluminium haute résistance, joint debout, personnalisable. Devis gratuit sous 24h.",
};

export default function AluPrefaPage() {
  const avantages = [
    "Certification officielle Prefa Académie",
    "Résistance exceptionnelle aux conditions extrêmes",
    "Matériau 100% recyclable et durable",
    "Technique joint debout sans fixations visibles",
    "Palette de couleurs personnalisables",
    "Très léger et facilité d'installation"
  ];
  ...
  return (
    <>
      ...
      <PageHero
        title="Aluminium Prefa"
        subtitle="Haute performance et résistance extrême"
        backgroundImage="/background/bg-aluprefa.webp"
      />
      ...
      <div className="bg-slate-100 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-yellow">Alu Prefa</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-700 leading-relaxed mb-4">
                  Formdetoit est artisan certifié <strong>Prefa Académie</strong>. Nos équipes
                  sont formées aux techniques de pose Prefa pour garantir une installation conforme
                  aux standards les plus exigeants.
                </p>
                <p className="text-xl text-gray-700 leading-relaxed">
                  Ce matériau aluminium haute qualité bénéficie d'une <strong>garantie fabricant
                  de 35 ans</strong> et offre une résistance exceptionnelle aux conditions climatiques
                  extrêmes. Léger et durable, il s'adapte parfaitement aux architectures traditionnelles
                  et modernes avec la technique du joint debout mécaniquement serti pour une étanchéité optimale.
                </p>
            ...
            <AnimatedSection direction="right">
              <div className="relative">
                <Image
                  src="/prefa.webp"
                  alt="Aluminium Prefa - Formdetoit Bas-Rhin"
                  width={600}
                  height={500}
                ...
                <div className="absolute -bottom-6 -right-6 glass rounded-xl p-6 max-w-xs">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-700">Certifié Prefa Académie</div>
                  </div>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Pourquoi choisir <span className="text-yellow">Alu Prefa</span> ?
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Découvrez tous les avantages de cette solution haute performance.
              </p>
            </div>
            ...
            <AnimatedSection direction="left">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Votre projet en <span className="text-yellow">Alu Prefa</span>
                </h2>
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Bénéficiez de notre certification Prefa pour une toiture aluminium 
                  d'exception. Idéal pour les régions aux climats variables comme 
                  l'Alsace, résiste aux variations de température, pluies intenses et neige.
                </p>
